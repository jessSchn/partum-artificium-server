/*
    Definition for a test case for a BodyPart.
...
#ifndef BODYPARTTEST_H
#define BODYPARTTEST_H
...
class BodyPartTest : public CppUnit::TestFixture
{
    CPPUNIT_TEST_SUITE(BodyPartTest);
    /**
